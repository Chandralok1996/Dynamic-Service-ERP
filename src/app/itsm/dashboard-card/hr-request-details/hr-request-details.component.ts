...
@Component({
  selector: 'app-hr-request-details',
  templateUrl: './hr-request-details.component.html',
  styleUrls: ['./hr-request-details.component.css']
})
export class HrRequestDetailsComponent {
  formData: any;
  ...
  displayedColumns: string[] = ['ticket_no','problem','Department','callType','Priority','Status'];
        ...
        .subscribe((res: any) => {
          ...
          if (this.reportData.length != 0) {
            if(this.status == 'Closed'){
              this.reportStatusData = this.reportData[2].hrListClosed;
            }
